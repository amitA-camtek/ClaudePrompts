...
| [`01_state_service_discovery.md`](01_state_service_discovery.md) | Discovery (Standalone Variant) | Map service-oriented integration points, callback ownership, and publisher adapter hooks | Access to Falcon.Net + AOI_Main source + `stateService/output/system.md` |
| [`02_state_service_alternatives.md`](02_state_service_alternatives.md) | Architecture (Standalone Variant) | Compare gRPC vs Named Pipes vs Hybrid for out-of-process state service | `stateService/output/01_state_service_structured_findings.md` |
| [`03_state_service_design.md`](03_state_service_design.md) | Design (Standalone Variant) | Produce implementation-grade service design with contracts, ownership, sequences, and migration | `stateService/output/02_state_service_alternatives_comparison.md` |
| [`04_state_service_implementation.md`](04_state_service_implementation.md) | Implementation (Standalone Variant) | Implement out-of-process state service + Falcon.Net publisher adapter + AOI_Main consumer adapter | `stateService/output/03_state_service_design.md` |
